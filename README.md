...
Ao clicar em <a href="https://toducks.vercel.app/" target="_blank">ToDucks</a>🔗 o site irá abrir para que possa utilizá-lo. Ele salvará as informações de seus tasks em localstorage graças ao redux-persist, é possível criar, excluir, editar e saber quantas tasks você criou, isso é feito através do gerenciamento de estados globais com Redux;
